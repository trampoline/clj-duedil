...
(def-api-method get-company
  "(get-company <client> <company-id-str> :fields <field-list-str> :traversal <traversal-maps>)"
  :company_id "company/:company_id.json" [[:fields "get_all"] [:traversal encode-traversals]])

(def-api-method get-registered-address
  "(get-registered-address <client> <company-id-str> :fields <field-list-str> :traversal <traversal-maps>)"
